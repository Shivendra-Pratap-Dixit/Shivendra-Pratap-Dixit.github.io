...
import "./Skills.css"
import { SiChakraui, SiHtml5, SiMaterialdesignicons, SiRedux, SiTypescript } from "react-icons/si";
  ...
  <div id="skills">
        ...
        <div  data-aos="fade-right" className="skills_icons">
         ...
         <div  className="skills-card">
          ...
          <h6 className="skills-card-name">ChakraUi</h6>
         </div>

         <div  className="skills-card">
          <SiMaterialdesignicons class="skills-card-img"/>
